...
import com.java17hcb.library.utils.Encryption;
...
public class LoginFrame extends javax.swing.JFrame {    
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String password = Encryption.get_SHA_512_SecurePassword(pfPassword.getText(), Encryption.SALT);
        Staff currentStaff = BusStaff.getInstance().login(tfUsername.getText(), password);
